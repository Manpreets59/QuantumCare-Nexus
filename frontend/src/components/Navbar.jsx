...
function Navbar() {
  ...
  const socialLinks = [
    {
      to: "https://github.com/Manpreets59/QuantumCare-Nexus",
      label: "github",
      icon: FaGithub,
    },
    {
      to: "https://www.linkedin.com/in/manpreet-singh-b9411328a/",
      label: "linkedin",
      icon: FaLinkedinIn,
    },
    { to: "https://discord.com/channels/1312310978754510910/1312312829713453076", label: "discord", icon: FaDiscord },
  ];
